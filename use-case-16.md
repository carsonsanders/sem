...
As an organisation we need to have a report on the top N populated cities in a district where N is provided by the user so we have access to population information.
### Scope
...
1. Organisation requests report on the top N populated cities in a district where N is provided by the user.
