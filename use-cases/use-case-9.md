# USE CASE 9 : Produce a report on on all the cities in a region organised by largest population to smallest
...
1. Organisation requests report on all the cities in a region organised by largest population to smallest.
